...
import org.xry.interceptors.interceptors.LoginInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(loginInterceptor)
                .excludePathPatterns(
                        "/Admin/login","/Admin/register","/Admin/messageLoginSend",
                        "/Admin/mLogin","/Admin/MessageLoginValidate").order(1);
